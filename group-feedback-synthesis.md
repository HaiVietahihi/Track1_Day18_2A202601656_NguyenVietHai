...
**Nguồn:** Feedback 1 là bản của Nguyễn Hoàng Minh, tester là một learner từng dùng AI hỏi bài học và dùng ChatGPT nhiều nhất. Feedback 2 là bản của Nguyễn Việt Hải, tester là Nguyễn Thị Thương, phòng D304. Feedback 3 là bản của Trịnh Hải Đăng; buổi này lệch protocol theo đúng những gì Hải đã chỉ ra, và còn có lỗi mô tả sai cơ chế Option C, nên được xếp vào diện dữ liệu tham khảo.
...
Nghiêm trọng hơn cách dẫn buổi, nội dung buổi này còn mô tả sai cơ chế của Option C. Đăng giải thích C bằng logic mức độ tự tin của AI để quyết định có đẩy câu hỏi cho Lab code hay không, đang thiết lập ở mức cao. Đây là cơ chế của Option B, không phải C. Đặc tả gốc của C là khớp câu hỏi với thư viện đã coach duyệt từ trước và hiện tên người duyệt, nhưng khi tester hỏi có biết đích danh người duyệt không, Đăng trả lời sẽ ẩn danh, ngược với đặc tả. Vì vậy toàn bộ phản hồi của Feedback 3 về bản C không phản ánh đúng thiết kế C thật và không dùng để đánh giá C.

## Bảng tổng hợp

| Nội dung | Feedback 1 | Feedback 2 | Feedback 3 (dữ liệu tham khảo) | Pattern hoặc khác biệt |
|---|---|---|---|---|
